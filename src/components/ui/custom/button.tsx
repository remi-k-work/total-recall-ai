...
const buttonVariants = cva(
  cn(
    "flex shrink-0 items-center justify-center gap-2 border whitespace-nowrap transition-all duration-300 ease-in-out outline-none uppercase tracking-widest font-semibold",
